  ...
  return (
    <PageTransition>
      ...
      <LuxuryBanner
        ...
        image="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a1/Boubou_homme.jpg/960px-Boubou_homme.jpg"
      />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center group">
                ...
                <div>
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-2 text-[11px] font-medium uppercase tracking-[0.2em] text-obsidian/70 hover:text-gold transition-colors duration-300"
                  >
                    Read More
              ...
              {remainingPosts.map((post, i) => (
                ...
                >
                  <Link href={`/journal/${post.slug}`} className="block">
                    ...
                    {/* Category label */}
                    <p className="text-[11px] font-medium uppercase tracking-[0.3em] text-obsidian/70 mb-2">
                      {post.category}
                    </p>
