  ...
  return (
    <PageTransition>
      ...
      <LuxuryBanner
        ...
        image="https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/African_Fashion.jpg/960px-African_Fashion.jpg"
      />
      ...
      <section className="py-16 md:py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
            <div>
              <p className="text-[11px] font-medium uppercase tracking-[0.3em] text-obsidian/70 mb-3 md:mb-4">
                Send a Message
              </p>
      ...
      <section className="h-64 md:h-96 bg-ivory flex items-center justify-center">
        <div className="text-center">
          <MapPin className="w-10 h-10 text-obsidian mx-auto mb-4" />
