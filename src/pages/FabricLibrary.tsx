        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          >
            <SectionTitle
              ...
              description="From the heritage mills of Biella to the handlooms of West Africa, every fabric in the REGALIA library is selected through rigorous standards of quality, provenance, and character. We travel the world so you can wear the world."
            />
          </motion.div>
            ...
            {fabrics.map((fabric, i) => (
              ...
              >
                ...
                <div className="relative aspect-square overflow-hidden mb-6">
                  ...
                  />
                  {/* Gold origin badge */}
                  <div className="absolute top-4 left-4 bg-gold/90 text-white text-[10px] font-medium uppercase tracking-[0.2em] px-3 py-1.5">
                    {fabric.origin}
                  </div>
                </div>
                ...
                <p className="text-[11px] uppercase tracking-[0.15em] text-gold mb-3">
                  {fabric.origin}
                </p>
