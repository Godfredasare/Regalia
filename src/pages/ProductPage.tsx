        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          >
            ...
            >
              ...
              <motion.div variants={fadeUpChild}>
                <Link
                  to={`/collections/${product.category.toLowerCase().replace(/\s+/g, '-')}`}
                  className="text-[11px] uppercase tracking-[0.2em] text-gold border-b border-gold/50 pb-0.5 hover:border-gold transition-colors duration-300"
                >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            {infoCards.map((card, i) => (
              <motion.div
                ...
                variants={fadeUp}
                className="flex items-start gap-4 md:gap-5 bg-white p-6 md:p-8"
              >
                <card.icon
                  className="w-7 h-7 text-gold shrink-0 mt-0.5"
                  strokeWidth={1.5}
                />
                <div>
